...
const Home = () => {
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    fetch("http://localhost:4000/api/placement/placed-students") // ✅ Fetch all students initially
      .then((res) => res.json())
      .then((data) => {
        setStudentDetails(data);
  ...
  useEffect(() => {
    fetch("http://localhost:4000/api/placement/placed-student-companies") // ✅ Fetch companies from placed_student table
      .then((res) => res.json())
      .then((data) => {
...
useEffect(() => {
  fetch("http://localhost:4000/api/placement/recruiterscount") // ✅ Corrected API URL
    .then((res) => res.json())
    .then((data) => {
