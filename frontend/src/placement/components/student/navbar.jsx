    ...
    <>
      <nav style={styles.navbar}>
        ...
        <ul style={styles.navbarLinks}>
          ...
          <li>
            <Link to="/placement/recruiters" style={styles.navbarLinksA}>
              Recruiters
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/placement/feedback" style={styles.navbarLinksA}>
              Feedback
            </Link>
          </li>
          <li>
            <Link to="/records/student" style={styles.navbarLinksA}>
              Return home
            </Link>
          </li>
        </ul>
